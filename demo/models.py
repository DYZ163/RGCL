...
class AE_3views(nn.Module):
    ...
    def __init__(self, n_stacks, n_input, n_z):
        ...
        self.enc0_4 = Linear(dims0[2], dims0[3])
        self.z0_layer = Linear(dims0[3], n_z)
        # encoder1
        self.enc1_1 = Linear(n_input[1], dims1[0])
        self.enc1_2 = Linear(dims1[0], dims1[1])
        self.enc1_3 = Linear(dims1[1], dims1[2])
        self.enc1_4 = Linear(dims1[2], dims1[3])
        self.z1_layer = Linear(dims1[3], n_z)
        # encoder2
        self.enc2_1 = Linear(n_input[2], dims2[0])
        self.enc2_2 = Linear(dims2[0], dims2[1])
        self.enc2_3 = Linear(dims2[1], dims2[2])
        self.enc2_4 = Linear(dims2[2], dims2[3])
        self.z2_layer = Linear(dims2[3], n_z)

        # decoder0
        self.dec0_0 = Linear(n_z, n_z)
        self.dec0_1 = Linear(n_z, dims0[3])
        self.dec0_2 = Linear(dims0[3], dims0[2])
        self.dec0_3 = Linear(dims0[2], dims0[1])
        self.dec0_4 = Linear(dims0[1], dims0[0])
        self.x0_bar_layer = Linear(dims0[0], n_input[0])
        # decoder1
        self.dec1_0 = Linear(n_z, n_z)
        self.dec1_1 = Linear(n_z, dims1[3])
        self.dec1_2 = Linear(dims1[3], dims1[2])
        self.dec1_3 = Linear(dims1[2], dims1[1])
        self.dec1_4 = Linear(dims1[1], dims1[0])
        self.x1_bar_layer = Linear(dims1[0], n_input[1])
        # decoder2
        self.dec2_0 = Linear(n_z, n_z)
        self.dec2_1 = Linear(n_z, dims2[3])
        self.dec2_2 = Linear(dims2[3], dims2[2])
        self.dec2_3 = Linear(dims2[2], dims2[1])
        self.dec2_4 = Linear(dims2[1], dims2[0])
...
class AE_2views(nn.Module):
    ...
    def __init__(self, n_stacks, n_input, n_z):
        ...
        # # encoder0
        # self.enc0_1 = kanlinear(n_input[0], dims0[0])
        # self.enc0_2 = kanlinear(dims0[0], dims0[1])
        # self.enc0_3 = kanlinear(dims0[1], dims0[2])
        # self.z0_layer = kanlinear(dims0[2], n_z)
        # # encoder1
        # self.enc1_1 = kanlinear(n_input[1], dims1[0])
        # self.enc1_2 = kanlinear(dims1[0], dims1[1])
        # self.enc1_3 = kanlinear(dims1[1], dims1[2])
        # self.z1_layer = kanlinear(dims1[2], n_z)
        #
        # # decoder0
        # self.dec0_0 = kanlinear(n_z, n_z)
        # self.dec0_1 = kanlinear(n_z, dims0[2])
        # self.dec0_2 = kanlinear(dims0[2], dims0[1])
        # self.dec0_3 = kanlinear(dims0[1], dims0[0])
        # self.x0_bar_layer = kanlinear(dims0[0], n_input[0])
        # # decoder1
        # self.dec1_0 = kanlinear(n_z, n_z)
        # self.dec1_1 = kanlinear(n_z, dims1[2])
        # self.dec1_2 = kanlinear(dims1[2], dims1[1])
        # self.dec1_3 = kanlinear(dims1[1], dims1[0])
        # self.x1_bar_layer = kanlinear(dims1[0], n_input[1])
